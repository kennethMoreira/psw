    ...
    <?php include 'plantillasPhp/cabeceraIndex_plantilla.php' ; ?>  
        ...
        <div class="container">
            ...
            <div class="cuerpoCentral" >
                ...
                <div class="titu">UKGHJGJHGJHGJHG</div>
	...
	<div class="container">
		<div class="main row">
			...
			<article class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
					...
					<h3>&nbsp</h3>
					<div id="imgHome">
						<img src="../img/home.jpg" class="img-responsive" alt="Inicio">
					</div>
...
<br>
		...
		<h3><a href="iniciosesion.html" class="btn btn-lg btn-success">  Comenzemos  </a><br></h3>	
	...
	<footer>
		<div class="container">
			...
			<p>2015 PSW - Todos los derechos reservados</p>
