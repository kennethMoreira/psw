...
class cusuario_add extends cusuario {
	...
	function LoadDefaultValues() {
		...
		$this->contrasena->OldValue = $this->contrasena->CurrentValue;
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $usuario->id->FldCaption(), $usuario->id->ReqErrMsg)) ?>");
			elm = this.GetElements("x" + infix + "_id");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($usuario->id->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_id_persona");
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($usuario->id_persona->FldErrMsg()) ?>");
...
<?php if ($usuario->id->Visible) { // id ?>
	<div id="r_id" class="form-group">
		<label id="elh_usuario_id" for="x_id" class="col-sm-2 control-label ewLabel"><?php echo $usuario->id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="col-sm-10"><div<?php echo $usuario->id->CellAttributes() ?>>
<span id="el_usuario_id">
<input type="text" data-table="usuario" data-field="x_id" name="x_id" id="x_id" size="30" placeholder="<?php echo ew_HtmlEncode($usuario->id->getPlaceHolder()) ?>" value="<?php echo $usuario->id->EditValue ?>"<?php echo $usuario->id->EditAttributes() ?>>
</span>
...
<?php if ($usuario->usuario->Visible) { // usuario ?>
	<div id="r_usuario" class="form-group">
		<label id="elh_usuario_usuario" for="x_usuario" class="col-sm-2 control-label ewLabel"><?php echo $usuario->usuario->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $usuario->usuario->CellAttributes() ?>>
<span id="el_usuario_usuario">
<input type="text" data-table="usuario" data-field="x_usuario" name="x_usuario" id="x_usuario" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($usuario->usuario->getPlaceHolder()) ?>" value="<?php echo $usuario->usuario->EditValue ?>"<?php echo $usuario->usuario->EditAttributes() ?>>
</span>
...
<?php if ($usuario->contrasena->Visible) { // contrasena ?>
	<div id="r_contrasena" class="form-group">
		<label id="elh_usuario_contrasena" for="x_contrasena" class="col-sm-2 control-label ewLabel"><?php echo $usuario->contrasena->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $usuario->contrasena->CellAttributes() ?>>
<span id="el_usuario_contrasena">
<input type="text" data-table="usuario" data-field="x_contrasena" name="x_contrasena" id="x_contrasena" size="30" maxlength="50" placeholder="<?php echo ew_HtmlEncode($usuario->contrasena->getPlaceHolder()) ?>" value="<?php echo $usuario->contrasena->EditValue ?>"<?php echo $usuario->contrasena->EditAttributes() ?>>
</span>
...
<?php if ($usuario->id_persona->Visible) { // id_persona ?>
	<div id="r_id_persona" class="form-group">
		<label id="elh_usuario_id_persona" for="x_id_persona" class="col-sm-2 control-label ewLabel"><?php echo $usuario->id_persona->FldCaption() ?></label>
		<div class="col-sm-10"><div<?php echo $usuario->id_persona->CellAttributes() ?>>
<span id="el_usuario_id_persona">
<input type="text" data-table="usuario" data-field="x_id_persona" name="x_id_persona" id="x_id_persona" size="30" placeholder="<?php echo ew_HtmlEncode($usuario->id_persona->getPlaceHolder()) ?>" value="<?php echo $usuario->id_persona->EditValue ?>"<?php echo $usuario->id_persona->EditAttributes() ?>>
</span>
<?php echo $usuario->id_persona->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div>
