...
define("EW_PROJECT_ID", "{F5ED1BA2-2719-42D0-89B4-77B83E35EC62}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'sa6djTtO9VYk8sMk', TRUE); // Random key for encryption
...
define("EW_UPLOAD_DEST_PATH", "wwwroot/", TRUE); // Upload destination path (relative to app root)
