...
fpersonadelete.ValidateRequired = true;
<?php } else { ?>
fpersonadelete.ValidateRequired = false; 
<?php } ?>
...
<?php if ($persona->id->Visible) { // id ?>
		<th><span id="elh_persona_id" class="persona_id"><?php echo $persona->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->nombre->Visible) { // nombre ?>
		<th><span id="elh_persona_nombre" class="persona_nombre"><?php echo $persona->nombre->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->apellido->Visible) { // apellido ?>
		<th><span id="elh_persona_apellido" class="persona_apellido"><?php echo $persona->apellido->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->edad->Visible) { // edad ?>
		<th><span id="elh_persona_edad" class="persona_edad"><?php echo $persona->edad->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->cedula->Visible) { // cedula ?>
		<th><span id="elh_persona_cedula" class="persona_cedula"><?php echo $persona->cedula->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->_email->Visible) { // email ?>
		<th><span id="elh_persona__email" class="persona__email"><?php echo $persona->_email->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->id_tipo_persona->Visible) { // id_tipo_persona ?>
		<th><span id="elh_persona_id_tipo_persona" class="persona_id_tipo_persona"><?php echo $persona->id_tipo_persona->FldCaption() ?></span></th>
<?php } ?>
<?php if ($persona->id_sexo->Visible) { // id_sexo ?>
		<th><span id="elh_persona_id_sexo" class="persona_id_sexo"><?php echo $persona->id_sexo->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($persona->id->Visible) { // id ?>
		<td<?php echo $persona->id->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_id" class="persona_id">
...
<?php } ?>
<?php if ($persona->edad->Visible) { // edad ?>
		<td<?php echo $persona->edad->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_edad" class="persona_edad">
...
<?php } ?>
<?php if ($persona->cedula->Visible) { // cedula ?>
		<td<?php echo $persona->cedula->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_cedula" class="persona_cedula">
...
<?php } ?>
<?php if ($persona->id_tipo_persona->Visible) { // id_tipo_persona ?>
		<td<?php echo $persona->id_tipo_persona->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_id_tipo_persona" class="persona_id_tipo_persona">
...
<?php } ?>
<?php if ($persona->id_sexo->Visible) { // id_sexo ?>
		<td<?php echo $persona->id_sexo->CellAttributes() ?>>
<span id="el<?php echo $persona_delete->RowCnt ?>_persona_id_sexo" class="persona_id_sexo">
