...
class cpersona extends cTable {
	...
	function __construct() {
		...
		// Update Table
		$this->UpdateTable = "\"public\".\"persona\"";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('persona', 'persona', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// edad
		$this->edad = new cField('persona', 'persona', 'x_edad', 'edad', '"edad"', 'CAST("edad" AS varchar(255))', 3, -1, FALSE, '"edad"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->edad->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['edad'] = &$this->edad;

		// cedula
		$this->cedula = new cField('persona', 'persona', 'x_cedula', 'cedula', '"cedula"', '"cedula"', 200, -1, FALSE, '"cedula"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// id_tipo_persona
		$this->id_tipo_persona = new cField('persona', 'persona', 'x_id_tipo_persona', 'id_tipo_persona', '"id_tipo_persona"', 'CAST("id_tipo_persona" AS varchar(255))', 3, -1, FALSE, '"id_tipo_persona"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id_tipo_persona->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id_tipo_persona'] = &$this->id_tipo_persona;

		// id_sexo
		$this->id_sexo = new cField('persona', 'persona', 'x_id_sexo', 'id_sexo', '"id_sexo"', 'CAST("id_sexo" AS varchar(255))', 3, -1, FALSE, '"id_sexo"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "\"public\".\"persona\"";
	}
   ...
   // Common render codes
	...
	function RenderEditRow() {
		...
		$this->id_tipo_persona->EditValue = $this->id_tipo_persona->CurrentValue;
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					...
					if ($this->id_tipo_persona->Exportable) $Doc->ExportCaption($this->id_tipo_persona);
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						...
						if ($this->id_tipo_persona->Exportable) $Doc->ExportField($this->id_tipo_persona);
