...
<?php if ($usuario->usuario->Visible) { // usuario ?>
		<th><span id="elh_usuario_usuario" class="usuario_usuario"><?php echo $usuario->usuario->FldCaption() ?></span></th>
<?php } ?>
<?php if ($usuario->contrasena->Visible) { // contrasena ?>
		<th><span id="elh_usuario_contrasena" class="usuario_contrasena"><?php echo $usuario->contrasena->FldCaption() ?></span></th>
<?php } ?>
<?php if ($usuario->id_persona->Visible) { // id_persona ?>
		<th><span id="elh_usuario_id_persona" class="usuario_id_persona"><?php echo $usuario->id_persona->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($usuario->id_persona->Visible) { // id_persona ?>
		<td<?php echo $usuario->id_persona->CellAttributes() ?>>
<span id="el<?php echo $usuario_delete->RowCnt ?>_usuario_id_persona" class="usuario_id_persona">
