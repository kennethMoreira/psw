...
<?php if ($persona->cedula->Visible) { // cedula ?>
	<tr id="r_cedula">
		<td><span id="elh_persona_cedula"><?php echo $persona->cedula->FldCaption() ?></span></td>
...
<?php echo $persona->cedula->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($persona->id_tipo_persona->Visible) { // id_tipo_persona ?>
	<tr id="r_id_tipo_persona">
		<td><span id="elh_persona_id_tipo_persona"><?php echo $persona->id_tipo_persona->FldCaption() ?></span></td>
...
<?php echo $persona->id_tipo_persona->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($persona->id_sexo->Visible) { // id_sexo ?>
	<tr id="r_id_sexo">
		<td><span id="elh_persona_id_sexo"><?php echo $persona->id_sexo->FldCaption() ?></span></td>
...
<?php echo $persona->id_sexo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
