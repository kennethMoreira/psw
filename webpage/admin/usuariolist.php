...
class cusuario_list extends cusuario {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->contrasena->AdvancedSearch->ToJSON(), ","); // Field contrasena
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->contrasena, $arKeywords, $type);
		return $sWhere;
	}
...
<?php if ($usuario->id->Visible) { // id ?>
	<?php if ($usuario->SortUrl($usuario->id) == "") { ?>
		<th data-name="id"><div id="elh_usuario_id" class="usuario_id"><div class="ewTableHeaderCaption"><?php echo $usuario->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->id) ?>',1);"><div id="elh_usuario_id" class="usuario_id">
...
<?php if ($usuario->usuario->Visible) { // usuario ?>
	<?php if ($usuario->SortUrl($usuario->usuario) == "") { ?>
		<th data-name="usuario"><div id="elh_usuario_usuario" class="usuario_usuario"><div class="ewTableHeaderCaption"><?php echo $usuario->usuario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="usuario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->usuario) ?>',1);"><div id="elh_usuario_usuario" class="usuario_usuario">
...
<?php if ($usuario->contrasena->Visible) { // contrasena ?>
	<?php if ($usuario->SortUrl($usuario->contrasena) == "") { ?>
		<th data-name="contrasena"><div id="elh_usuario_contrasena" class="usuario_contrasena"><div class="ewTableHeaderCaption"><?php echo $usuario->contrasena->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="contrasena"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->contrasena) ?>',1);"><div id="elh_usuario_contrasena" class="usuario_contrasena">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->contrasena->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($usuario->contrasena->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->contrasena->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($usuario->id_persona->Visible) { // id_persona ?>
	<?php if ($usuario->SortUrl($usuario->id_persona) == "") { ?>
		<th data-name="id_persona"><div id="elh_usuario_id_persona" class="usuario_id_persona"><div class="ewTableHeaderCaption"><?php echo $usuario->id_persona->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_persona"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuario->SortUrl($usuario->id_persona) ?>',1);"><div id="elh_usuario_id_persona" class="usuario_id_persona">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuario->id_persona->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuario->id_persona->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuario->id_persona->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_usuario" class="usuario_usuario">
...
<?php echo $usuario->contrasena->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($usuario->id_persona->Visible) { // id_persona ?>
		<td data-name="id_persona"<?php echo $usuario->id_persona->CellAttributes() ?>>
<span id="el<?php echo $usuario_list->RowCnt ?>_usuario_id_persona" class="usuario_id_persona">
<span<?php echo $usuario->id_persona->ViewAttributes() ?>>
<?php echo $usuario->id_persona->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
