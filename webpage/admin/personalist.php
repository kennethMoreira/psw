...
class cpersona_list extends cpersona {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->id_tipo_persona->AdvancedSearch->ToJSON(), ","); // Field id_tipo_persona
	...
	function RestoreFilterList() {
		...
		$this->id_tipo_persona->AdvancedSearch->SearchValue = @$filter["x_id_tipo_persona"];
		$this->id_tipo_persona->AdvancedSearch->SearchOperator = @$filter["z_id_tipo_persona"];
		$this->id_tipo_persona->AdvancedSearch->SearchCondition = @$filter["v_id_tipo_persona"];
		$this->id_tipo_persona->AdvancedSearch->SearchValue2 = @$filter["y_id_tipo_persona"];
		$this->id_tipo_persona->AdvancedSearch->SearchOperator2 = @$filter["w_id_tipo_persona"];
		$this->id_tipo_persona->AdvancedSearch->Save();
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->id_tipo_persona); // id_tipo_persona
			$this->UpdateSort($this->id_sexo); // id_sexo
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->cedula->setSort("");
				$this->_email->setSort("");
				$this->id_tipo_persona->setSort("");
				$this->id_sexo->setSort("");
			}
...
<?php if ($persona->id->Visible) { // id ?>
	<?php if ($persona->SortUrl($persona->id) == "") { ?>
		<th data-name="id"><div id="elh_persona_id" class="persona_id"><div class="ewTableHeaderCaption"><?php echo $persona->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->id) ?>',1);"><div id="elh_persona_id" class="persona_id">
...
<?php if ($persona->edad->Visible) { // edad ?>
	<?php if ($persona->SortUrl($persona->edad) == "") { ?>
		<th data-name="edad"><div id="elh_persona_edad" class="persona_edad"><div class="ewTableHeaderCaption"><?php echo $persona->edad->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="edad"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->edad) ?>',1);"><div id="elh_persona_edad" class="persona_edad">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $persona->edad->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($persona->edad->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($persona->edad->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($persona->cedula->Visible) { // cedula ?>
	<?php if ($persona->SortUrl($persona->cedula) == "") { ?>
		<th data-name="cedula"><div id="elh_persona_cedula" class="persona_cedula"><div class="ewTableHeaderCaption"><?php echo $persona->cedula->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="cedula"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->cedula) ?>',1);"><div id="elh_persona_cedula" class="persona_cedula">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $persona->cedula->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($persona->cedula->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($persona->cedula->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($persona->_email->Visible) { // email ?>
	<?php if ($persona->SortUrl($persona->_email) == "") { ?>
		<th data-name="_email"><div id="elh_persona__email" class="persona__email"><div class="ewTableHeaderCaption"><?php echo $persona->_email->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="_email"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->_email) ?>',1);"><div id="elh_persona__email" class="persona__email">
...
<?php if ($persona->id_tipo_persona->Visible) { // id_tipo_persona ?>
	<?php if ($persona->SortUrl($persona->id_tipo_persona) == "") { ?>
		<th data-name="id_tipo_persona"><div id="elh_persona_id_tipo_persona" class="persona_id_tipo_persona"><div class="ewTableHeaderCaption"><?php echo $persona->id_tipo_persona->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_tipo_persona"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->id_tipo_persona) ?>',1);"><div id="elh_persona_id_tipo_persona" class="persona_id_tipo_persona">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $persona->id_tipo_persona->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($persona->id_tipo_persona->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($persona->id_tipo_persona->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($persona->id_sexo->Visible) { // id_sexo ?>
	<?php if ($persona->SortUrl($persona->id_sexo) == "") { ?>
		<th data-name="id_sexo"><div id="elh_persona_id_sexo" class="persona_id_sexo"><div class="ewTableHeaderCaption"><?php echo $persona->id_sexo->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_sexo"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $persona->SortUrl($persona->id_sexo) ?>',1);"><div id="elh_persona_id_sexo" class="persona_id_sexo">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $persona->id_sexo->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($persona->id_sexo->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($persona->id_sexo->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
<?php echo $persona->apellido->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($persona->edad->Visible) { // edad ?>
		<td data-name="edad"<?php echo $persona->edad->CellAttributes() ?>>
<span id="el<?php echo $persona_list->RowCnt ?>_persona_edad" class="persona_edad">
<span<?php echo $persona->edad->ViewAttributes() ?>>
<?php echo $persona->edad->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($persona->cedula->Visible) { // cedula ?>
		<td data-name="cedula"<?php echo $persona->cedula->CellAttributes() ?>>
<span id="el<?php echo $persona_list->RowCnt ?>_persona_cedula" class="persona_cedula">
<span<?php echo $persona->cedula->ViewAttributes() ?>>
<?php echo $persona->cedula->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($persona->_email->Visible) { // email ?>
...
<?php echo $persona->_email->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($persona->id_tipo_persona->Visible) { // id_tipo_persona ?>
		<td data-name="id_tipo_persona"<?php echo $persona->id_tipo_persona->CellAttributes() ?>>
<span id="el<?php echo $persona_list->RowCnt ?>_persona_id_tipo_persona" class="persona_id_tipo_persona">
<span<?php echo $persona->id_tipo_persona->ViewAttributes() ?>>
<?php echo $persona->id_tipo_persona->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($persona->id_sexo->Visible) { // id_sexo ?>
		<td data-name="id_sexo"<?php echo $persona->id_sexo->CellAttributes() ?>>
<span id="el<?php echo $persona_list->RowCnt ?>_persona_id_sexo" class="persona_id_sexo">
<span<?php echo $persona->id_sexo->ViewAttributes() ?>>
<?php echo $persona->id_sexo->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
