...
class cusuario extends cTable {
	...
	function __construct() {
		...
		// id
		$this->id = new cField('usuario', 'usuario', 'x_id', 'id', '"id"', 'CAST("id" AS varchar(255))', 3, -1, FALSE, '"id"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// usuario
		$this->usuario = new cField('usuario', 'usuario', 'x_usuario', 'usuario', '"usuario"', '"usuario"', 200, -1, FALSE, '"usuario"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['usuario'] = &$this->usuario;

		// contrasena
		$this->contrasena = new cField('usuario', 'usuario', 'x_contrasena', 'contrasena', '"contrasena"', '"contrasena"', 200, -1, FALSE, '"contrasena"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['contrasena'] = &$this->contrasena;

		// id_persona
		$this->id_persona = new cField('usuario', 'usuario', 'x_id_persona', 'id_persona', '"id_persona"', 'CAST("id_persona" AS varchar(255))', 3, -1, FALSE, '"id_persona"', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "\"public\".\"usuario\"";
	}
