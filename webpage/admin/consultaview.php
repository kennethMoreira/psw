...
var CurrentForm = fconsultaview = new ew_Form("fconsultaview", "view");
...
<?php if ($consulta->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_consulta_id"><?php echo $consulta->id->FldCaption() ?></span></td>
		<td data-name="id"<?php echo $consulta->id->CellAttributes() ?>>
<span id="el_consulta_id">
<span<?php echo $consulta->id->ViewAttributes() ?>>
<?php echo $consulta->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consulta->id_estudiante->Visible) { // id_estudiante ?>
	<tr id="r_id_estudiante">
		<td><span id="elh_consulta_id_estudiante"><?php echo $consulta->id_estudiante->FldCaption() ?></span></td>
...
<?php echo $consulta->id_estudiante->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consulta->id_paciente->Visible) { // id_paciente ?>
	<tr id="r_id_paciente">
		<td><span id="elh_consulta_id_paciente"><?php echo $consulta->id_paciente->FldCaption() ?></span></td>
...
<?php echo $consulta->id_paciente->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($consulta->id_horario->Visible) { // id_horario ?>
	<tr id="r_id_horario">
		<td><span id="elh_consulta_id_horario"><?php echo $consulta->id_horario->FldCaption() ?></span></td>
...
<?php echo $consulta->id_horario->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
