...
@define("EW_USER_LEVEL_ID_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelIdFld, sUserLevelDBID))##-->", TRUE);
@define("EW_USER_LEVEL_NAME_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelNameFld, sUserLevelDBID))##-->", TRUE);
...
@define("EW_USER_LEVEL_PRIV_TABLE_NAME_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivTblNameFld, sUserLevelPrivDBID))##-->", TRUE);
...
@define("EW_USER_LEVEL_PRIV_USER_LEVEL_ID_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivUserLevelFld, sUserLevelPrivDBID))##-->", TRUE);
@define("EW_USER_LEVEL_PRIV_PRIV_FIELD", "<!--##=ew_Quote2(ew_QuotedName(DB.UserLevelPrivPrivFld, sUserLevelPrivDBID))##-->", TRUE);
<!--## } ##-->
