...
ewAr[345] = ""+"\r\n"+"<?php $";
ewAr[346] = "->ShowPageHeader(); ?>"+"\r\n"+"";
ewAr[347] = ""+"\r\n"+"";
ewAr[348] = ""+"\r\n"+"<?php"+"\r\n"+"$";
ewAr[349] = "->ShowMessage();"+"\r\n"+"?>"+"\r\n"+"";
ewAr[350] = ""+"\r\n"+""+"\r\n"+"<form name=\"";
ewAr[351] = "\" id=\"";
ewAr[352] = "\" class=\"form-horizontal ewForm ewForgotpwdForm\" action=\"<?php echo ew_CurrentPage() ?>\" method=\"post\">"+"\r\n"+"<?php if ($";
ewAr[353] = "->CheckToken) { ?>"+"\r\n"+"<input type=\"hidden\" name=\"<?php echo EW_TOKEN_NAME ?>\" value=\"<?php echo $";
ewAr[354] = "->Token ?>\">"+"\r\n"+"<?php } ?>"+"\r\n"+""+"\r\n"+"";
ewAr[355] = ""+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<label class=\"";
ewAr[356] = "\" for=\"email\">";
ewAr[357] = "</label>"+"\r\n"+"		<div class=\"";
ewAr[358] = "\"><input type=\"text\" name=\"email\" id=\"email\" class=\"";
ewAr[359] = "\" value=\"<?php ew_HtmlEncode($";
ewAr[360] = "->Email) ?>\"";
ewAr[361] = "></div>"+"\r\n"+"	</div>"+"\r\n"+""+"\r\n"+"";
ewAr[362] = ""+"\r\n"+"";
ewAr[363] = ""+"\r\n"+""+"\r\n"+"	<div class=\"form-group\">"+"\r\n"+"		<div class=\"";
ewAr[364] = "\">"+"\r\n"+"			<button class=\"";
ewAr[365] = "\" name=\"btnsubmit\" id=\"btnsubmit\" type=\"submit\"><?php echo $Language->Phrase(\"SendPwd\") ?></button>"+"\r\n"+"		</div>"+"\r\n"+"	</div>"+"\r\n"+""+"\r\n"+"</form>"+"\r\n"+""+"\r\n"+"<script type=\"text/javascript\">"+"\r\n"+"";
ewAr[366] = ".Init();"+"\r\n"+"</script>"+"\r\n"+""+"\r\n"+"";
ewAr[367] = ""+"\r\n"+"<?php"+"\r\n"+"$";
ewAr[368] = "->ShowPageFooter();"+"\r\n"+"if (EW_DEBUG_ENABLED)"+"\r\n"+"	echo ew_DebugMsg();"+"\r\n"+"?>"+"\r\n"+"";
ewAr[369] = ""+"\r\n"+"";
ewAr[370] = ""+"\r\n"+"";
ewAr[371] = ""+"\r\n"+"";
ewAr[372] = ""+"\r\n"+"";
ewAr[373] = ""+"\r\n"+"<?php"+"\r\n"+"$";
ewAr[374] = "->Page_Terminate();"+"\r\n"+"?>"+"\r\n"+"";
...
ew_IndentWrk = "	";
ewSB.Append("\r\n"+ew_IndentWrk);
ewSB.Append(SYSTEMFUNCTIONS.GetServerScript("Other","User_RecoverPassword"));
...
// *** Start Session forgotpwd_htm (key, 2/14/2016 9:08:34 PM)
...
ewSB.Append("<?php echo $Language->Phrase(\"UserEmail\") ?>");
...
ewSB.Append(sEmailFldTagSize);
ewSB.Append(sEmailFldTagMaxLength);
...
// *** End Session forgotpwd_htm (key, 2/14/2016 9:08:34 PM)
