...
class cconsulta_list extends cconsulta {
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->id_estudiante); // id_estudiante
			$this->UpdateSort($this->id_paciente); // id_paciente
			$this->UpdateSort($this->id_horario); // id_horario
	...
	function ResetCmd() {
		...
		if (substr($this->Command,0,5) == "reset") {
			...
			if ($this->Command == "resetsort") {
				...
				$this->setSessionOrderBy($sOrderBy);
				$this->id->setSort("");
				$this->id_estudiante->setSort("");
				$this->id_paciente->setSort("");
				$this->id_horario->setSort("");
			}
...
<?php if ($consulta->id->Visible) { // id ?>
	<?php if ($consulta->SortUrl($consulta->id) == "") { ?>
		<th data-name="id"><div id="elh_consulta_id" class="consulta_id"><div class="ewTableHeaderCaption"><?php echo $consulta->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $consulta->SortUrl($consulta->id) ?>',1);"><div id="elh_consulta_id" class="consulta_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $consulta->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($consulta->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($consulta->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($consulta->id_estudiante->Visible) { // id_estudiante ?>
	<?php if ($consulta->SortUrl($consulta->id_estudiante) == "") { ?>
		<th data-name="id_estudiante"><div id="elh_consulta_id_estudiante" class="consulta_id_estudiante"><div class="ewTableHeaderCaption"><?php echo $consulta->id_estudiante->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_estudiante"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $consulta->SortUrl($consulta->id_estudiante) ?>',1);"><div id="elh_consulta_id_estudiante" class="consulta_id_estudiante">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $consulta->id_estudiante->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($consulta->id_estudiante->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($consulta->id_estudiante->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($consulta->id_paciente->Visible) { // id_paciente ?>
	<?php if ($consulta->SortUrl($consulta->id_paciente) == "") { ?>
		<th data-name="id_paciente"><div id="elh_consulta_id_paciente" class="consulta_id_paciente"><div class="ewTableHeaderCaption"><?php echo $consulta->id_paciente->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_paciente"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $consulta->SortUrl($consulta->id_paciente) ?>',1);"><div id="elh_consulta_id_paciente" class="consulta_id_paciente">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $consulta->id_paciente->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($consulta->id_paciente->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($consulta->id_paciente->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($consulta->id_horario->Visible) { // id_horario ?>
	<?php if ($consulta->SortUrl($consulta->id_horario) == "") { ?>
		<th data-name="id_horario"><div id="elh_consulta_id_horario" class="consulta_id_horario"><div class="ewTableHeaderCaption"><?php echo $consulta->id_horario->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id_horario"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $consulta->SortUrl($consulta->id_horario) ?>',1);"><div id="elh_consulta_id_horario" class="consulta_id_horario">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $consulta->id_horario->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($consulta->id_horario->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($consulta->id_horario->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php
...
?>
	<?php if ($consulta->id->Visible) { // id ?>
		<td data-name="id"<?php echo $consulta->id->CellAttributes() ?>>
<span id="el<?php echo $consulta_list->RowCnt ?>_consulta_id" class="consulta_id">
<span<?php echo $consulta->id->ViewAttributes() ?>>
<?php echo $consulta->id->ListViewValue() ?></span>
</span>
<a id="<?php echo $consulta_list->PageObjName . "_row_" . $consulta_list->RowCnt ?>"></a></td>
	<?php } ?>
	<?php if ($consulta->id_estudiante->Visible) { // id_estudiante ?>
		<td data-name="id_estudiante"<?php echo $consulta->id_estudiante->CellAttributes() ?>>
<span id="el<?php echo $consulta_list->RowCnt ?>_consulta_id_estudiante" class="consulta_id_estudiante">
<span<?php echo $consulta->id_estudiante->ViewAttributes() ?>>
<?php echo $consulta->id_estudiante->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($consulta->id_paciente->Visible) { // id_paciente ?>
		<td data-name="id_paciente"<?php echo $consulta->id_paciente->CellAttributes() ?>>
<span id="el<?php echo $consulta_list->RowCnt ?>_consulta_id_paciente" class="consulta_id_paciente">
<span<?php echo $consulta->id_paciente->ViewAttributes() ?>>
<?php echo $consulta->id_paciente->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($consulta->id_horario->Visible) { // id_horario ?>
		<td data-name="id_horario"<?php echo $consulta->id_horario->CellAttributes() ?>>
<span id="el<?php echo $consulta_list->RowCnt ?>_consulta_id_horario" class="consulta_id_horario">
<span<?php echo $consulta->id_horario->ViewAttributes() ?>>
<?php echo $consulta->id_horario->ListViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
