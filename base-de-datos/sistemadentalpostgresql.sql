...
CREATE TABLE "ayuda" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "enfermedad" (  "id" INTEGER NOT NULL ,
  "nombre" VARCHAR(50) NULL ,
...
CREATE TABLE "universidad" (  "id" INTEGER NOT NULL ,
  "nombre" VARCHAR(50) NULL ,
  "descripcion" VARCHAR(50) NULL ,
  PRIMARY KEY ("id")
); 
...
CREATE TABLE "nivel_estudio" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "tipo_persona" (  "id" INTEGER NOT NULL ,
  "descripcion" VARCHAR(50) NULL ,
  PRIMARY KEY ("id")
); 
...
CREATE TABLE "sexo" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "horario" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "telefono" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "consulta" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "sysdiagrams" (  "name" VARCHAR(160) NOT NULL ,
...
CREATE TABLE "direccion" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "consulta_por_enfermedad" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "registro_actividad" (  "id" INTEGER NOT NULL ,
...
CREATE TABLE "diagnostico" (  "id" INTEGER NOT NULL ,
  "descripcion" VARCHAR(50) NULL ,
