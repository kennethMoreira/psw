...
<body>
    ...
    <div class="menu navbar-header">
      ...
      <!--logo-->
        <div class="logoI">
        	<a class="navbar-brand" href="index.php"><img src="img/logo.png" class="logoImg img-responsive"></a>
		</div>
    ...
    <div class="container-fluid">
        ...
        <div class="visible-lg hidden-xs hidden-sm visible-md cajaFantasma">
            ...
            <a class="ghost" href="admin/index.php">Inicia sesion<br><span>como administrador</span></a>
        </div>
    </div>